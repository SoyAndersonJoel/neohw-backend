...
export const RESET_PASSWORD_OTP_USE_CASE = Symbol('RESET_PASSWORD_OTP_USE_CASE');
export const VERIFY_ACCOUNT_OTP_USE_CASE = Symbol('VERIFY_ACCOUNT_OTP_USE_CASE');
